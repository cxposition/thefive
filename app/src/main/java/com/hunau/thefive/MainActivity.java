...
import com.hunau.thefive.DBAdapter;
import com.hunau.thefive.R;
import com.hunau.thefive.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setBackgroundColor(Color.parseColor("#ffcc33"));
        queryAllButton.setBackgroundColor(Color.parseColor("#ff3300"));
        clearButton.setBackgroundColor(Color.parseColor("#ffff00"));
        deleteAllButton.setBackgroundColor(Color.parseColor("#66ff00"));
        queryButton.setBackgroundColor(Color.parseColor("#ff99cc"));
        deleteButton.setBackgroundColor(Color.parseColor("#ffffff"));
        updateButton.setBackgroundColor(Color.parseColor("#ff00ff"));
