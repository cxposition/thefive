...
public class DBAdapter {
    ...
    private static final String KEY_SEXY = "sexy";
    private static final String KEY_ISUSED = "isused";
    ...
    private User[] ConvertToPeople(Cursor cursor){
        ...
        for (int i = 0 ; i<resultCounts; i++){
            ...
            users[i].setIsused(cursor.getInt(cursor.getColumnIndex(KEY_ISUSED))==1?true:false);
